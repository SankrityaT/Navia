  ...
  const tutorialStepsBento: TutorialStep[] = [
    {
      ...
      description: "I help you succeed, one step at a time.",
      targetSelector: '',
      position: 'center',
      icon: <Sparkles className="w-6 h-6" />,
      highlightColor: 'from-purple-400 to-purple-600',
    },
    {
      ...
      description: "I break down overwhelming tasks and provide support whenever you need it.",
    ...
    },
    {
      ...
      description: "Feeling overwhelmed? I will split any task into smaller, manageable steps.",
      targetSelector: '[data-tutorial="tasks"]',
      position: 'right',
      icon: <CheckCircle className="w-6 h-6" />,
      highlightColor: 'from-clay-400 to-clay-600',
      action: 'I can break down any task',
    },
    {
      id: 'energy-level',
      title: 'Energy Check-In 💚',
      description: "I adapt my suggestions based on your energy. Low energy days are okay.",
    ...
    },
    {
      id: 'support-level',
      title: 'Support Level 🤝',
      description: "Choose how much guidance you need - from minimal to maximum support.",
      targetSelector: '[data-tutorial="support-level"]',
      position: 'right',
      icon: <Target className="w-6 h-6" />,
      highlightColor: 'from-blue-400 to-blue-600',
      action: 'I adapt to your needs',
    },
    {
      id: 'focus-mode',
      title: 'Focus Sessions 🎯',
      description: "Start a focus session with calming music. I will stay with you.",
